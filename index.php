          ...
          <div class="product-container">
              <div class="product-card">
                  <div class="product-image">
                      ...
                      <a href="#"><img src="imagens/card1.jpg" class="product-thumb" alt=""></a>
    
                  </div>
                  <div class="product-info">
                      <h2 class="product-brand">produto</h2>
                      <a href="">
                          <p class="product-short-description">Saiba mais sobre o produto..</p>
                      </a>
              ...
              <div class="product-card">
                  <div class="product-image">
                      <span class="discount-tag">50% off</span>
                      <a href=""><img src="imagens/card2.jpg" class="product-thumb" alt=""></a>
                  </div>
                  <div class="product-info">
                      <h2 class="product-brand">produto</h2>
                      <a href="">
              ...
              <div class="product-card">
                  <div class="product-image">
                      <span class="discount-tag">50% off</span>
                      <a href=""><img src="imagens/card3.jpg" class="product-thumb" alt=""></a>
                  </div>
                  <div class="product-info">
                      <h2 class="product-brand">produto</h2>
                      <a href="">
              ...
              <div class="product-card">
                  <div class="product-image">
                      <span class="discount-tag">50% off</span>
                      <a href=""><img src="imagens/card4.jpg" class="product-thumb" alt=""></a>
                  </div>
                  <div class="product-info">
                      <h2 class="product-brand">produto</h2>
                      <a href="">
              ...
              <div class="product-card">
                  <div class="product-image">
                      <span class="discount-tag">50% off</span>
                      <a href=""><img src="imagens/card5.jpg" class="product-thumb" alt=""></a>
                  </div>
                  <div class="product-info">
                      <a href="">
                          <h2 class="product-brand">produto</h2>
              ...
              <div class="product-card">
                  <div class="product-image">
                      <span class="discount-tag">50% off</span>
                      <a href=""><img src="imagens/card6.jpg" class="product-thumb" alt=""></a>
                  </div>
                  <div class="product-info">
                      <h2 class="product-brand">produto</h2>
                      <a href="">
